...
ggsave("davies_vs_prediction.png", plot=davies_vs_prediction, dpi=600, width=3, height=2)
...
ggsave("dist_plot_index.png", plot=dist_plot_index, dpi=600)
...
index_vs_ELO <- ggplot(ELOvsINDEX, aes(x = corrected_index, y = Coach.Rating)) +
  ...
  geom_text(aes(x = 0.25, y = 1950, label = paste("r =", round(pearson_corr, 4))), 
            size = 2, color = "black", hjust = 0)  # Adjust text size for the correlation label


ggsave("index_vs_ELO.png", plot=index_vs_ELO, dpi=600, width=3, height=2)
