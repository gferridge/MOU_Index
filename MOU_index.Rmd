...
```{r data}
DAVIESdata.2024.04.02 <- read.csv("/MOU_index/DAVIESdata-2017-2024-raw.csv")
...
```{r}
wage_data <- read.csv("/MOU_index/wage_data.csv")
```
...
```{r}
Managers_DAVIES <- read.csv("/MOU_index/Managers_DAVIES.csv")
...
managerELO <- read.csv("/MOU_index/coaches_ranking.csv")
